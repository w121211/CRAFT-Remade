...
num_workers = {"train": 16, "test": 16}

# pretrained = True
pretrained = False
pretrained_path = "/home/SharedData/Mayank/Models/SYNTH/63000_model.pkl"
pretrained_loss_plot_training = (
    "/home/SharedData/Mayank/Models/SYNTH/loss_plot_training.npy"
)

lr = {1: 1e-4, 10000: 5e-5, 20000: 2e-5, 40000: 1e-5, 60000: 1e-6}
